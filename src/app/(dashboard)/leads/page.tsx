...
import { Skeleton } from "@/components/ui/skeleton"; // ✅ skeleton from shadcn/ui
import { Input } from "@/components/ui/input"; // ✅ search input from shadcn/ui
...
type Lead = {
  ...
  avatar: string | null;
  campaign: string | null;
  campaignDescription?: string | null; // ✅ from schema
  email: string;
  company: string | null;
